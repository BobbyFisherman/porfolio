...
window.addEventListener('scroll', () => {
    ...
    document.querySelector('.ambient-glow-1').style.transform =
        `translate(${scrollY * 0.05}px, ${scrollY * 0.02}px)`;
    document.querySelector('.ambient-glow-2').style.transform =
        `translate(-${scrollY * 0.03}px, -${scrollY * 0.04}px)`;
});
